...
const NowPlayDetail = () => {
    ...
    useEffect(() => {
        const fetchMovie = async () => {
            try {
                const response = await axios.get(`${BASE_URL}/${id}?api_key=${API_KEY}&language=${LANGUAGE}`);
        ...
        const fetchCredits = async () => {
            try {
                const response = await axios.get(`${BASE_URL}/${id}/credits?api_key=${API_KEY}&language=${LANGUAGE}`);
